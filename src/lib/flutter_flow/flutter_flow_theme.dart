...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFA84B74);
  late Color secondary = const Color(0xFFFBFBFB);
  late Color tertiary = const Color(0xFF872958);
  late Color alternate = const Color(0xFF2B2B2B);
  ...
  late Color customColor1 = Color(0xFF79E4D9);
}
