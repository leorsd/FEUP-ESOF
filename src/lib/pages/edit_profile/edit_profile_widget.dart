...
class _EditProfileWidgetState extends State<EditProfileWidget> {
  ...
  void initState() {
    ...
    _model.upnumberFocusNode ??= FocusNode();
        ...
        body: Container(
          ...
          child: Column(
            ...
            children: [
                ...
                child: Align(
                  ...
                  child: Stack(
                    children: [
                      ...
                      Align(
                        alignment: AlignmentDirectional(0.37, 1.46),
                        child: FlutterFlowIconButton(
                          borderRadius: 20.0,
                          buttonSize: 40.0,
              ...
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(20.0, 50.0, 10.0, 0.0),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Container(
                              width: 250.0,
                              child: TextFormField(
                                controller: _model.upnumberTextController ??=
                                    TextEditingController(
                                  text: listViewUsersRecord?.upNumber,
                                ),
                                focusNode: _model.upnumberFocusNode,
                                autofocus: false,
                                obscureText: false,
                                decoration: InputDecoration(
                                  isDense: true,
                                ...
                                cursorColor:
                                    FlutterFlowTheme.of(context).primaryText,
                                validator: _model
                                    .upnumberTextControllerValidator
                                    .asValidator(context),
                                inputFormatters: [
                            ...
                            Container(
                              ...
                              child: TextFormField(
                                controller: _model.facultyTextController ??=
                                    TextEditingController(
                                  text: listViewUsersRecord?.faculty,
                                ),
                                ...
                                cursorColor:
                                    FlutterFlowTheme.of(context).primaryText,
                                validator: _model.facultyTextControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                          ],
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                await currentUserReference!
                                  ...
                                  faculty: _model.facultyTextController.text,
                                  displayName:
                                      _model.displayNameTextController.text,
                                  upNumber: _model.upnumberTextController.text,
                                ));
